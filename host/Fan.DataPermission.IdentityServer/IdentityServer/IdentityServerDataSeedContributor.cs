...
namespace Fan.DataPermission.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("DataPermission", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            //Console Test Client
            var consoleClientId = configurationSection["DataPermission_ConsoleTestApp:ClientId"];
